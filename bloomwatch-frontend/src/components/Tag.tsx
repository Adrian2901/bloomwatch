...
const tagColors: Record<string, string> = {
  'Super Rare': 'bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg',
  'Rare': 'bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-md',
  'In Danger': 'bg-gradient-to-r from-red-600 to-red-700 text-white shadow-md',
  'Common': 'bg-gradient-to-r from-green-500 to-emerald-500 text-white shadow-sm',
